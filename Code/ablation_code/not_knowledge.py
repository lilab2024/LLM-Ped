...
with open("image/Slide18.png", "rb") as image_file:
...
Step 1: Analyze vehicle attributes.Through one's own reasoning.
Step 2: Evaluate road conditions.Through pictures and one's own reasoning.
Step 3: Analyze pedestrian-related characteristics.Through one's own reasoning.
...
Step 3: Pedestrian Characteristics
...
input_data = pd.read_csv('split_by_location_opposite/location_18.csv')
...
df.to_csv('ablation/not_knowledge_4o/output18.csv', index=False, encoding='utf-8')